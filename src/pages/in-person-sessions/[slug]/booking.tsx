...
export const CheckoutPage = () => {
  ...
  useEffect(() => {
    ...
    if (slug) {
      axios
        .get(`session/detail/${slug}?secret=11f24438-b63a-4de2-ae92-e1a1048706f5&`)
        .then((response) => {
      ...
      >
        <Card>
          <Stack>
            ...
            <SimpleGrid cols={2}>
              <Button
                id="btn-bookingBalanceModalCancel"
                variant="filled"
                onClick={() => {
              ...
              <Button
                id="btn-bookingBalanceModalRefill"
                variant="filled"
                onClick={() => {
                ...
                {isLoading ? (
                  ...
                  <Card radius={8}>
                    <Group noWrap position="apart" sx={{ position: 'relative' }}>
                      ...
                      >
                        {orignalPrice != 0 ? (
                          <Radio id="rdb-inPersonCard" value="card" label={t.booking.card} />
                        ) : null}
                        <Radio
                          id="rdb-inPersonWallet"
                          value="wallet"
                          label={t.booking['by-wallet']}
                        />
                      </RadioGroup>
                      {paymentCard === 'wallet' && (
                        <Text
